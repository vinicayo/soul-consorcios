...
function validar()
{
	//	valor = $("#nome").val();
	//	valor = $("#nome").val();
	valida = validar_campo_texto('nome');
	valida = validar_campo_texto('cidade');
	valida = validar_cep('cep');
	valida = validar_email('email');
	valida = validar_telefone('phone');
	if(valida == 0)
	{
		formContato.submit();
	}
	...
	{
		alert('Por gentileza preencha os campos marcados')
	}
}
